        ...
        <div class=" main-content-area">
                        ...
                        <li class="pr-cart-item">
                            ...
                            <?php $__currentLoopData = $item->options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div style="vertical-align: middle; width: 180px;">
                                    <p><b><?php echo e($key); ?>: <?php echo e($value); ?></b></p>
                                </div>
                            ...
                            <div class="quantity">
                                <div class="quantity-input">
                                    ...
                                    <a class="btn btn-increase" href="#" wire:click.prevent="increaseQty('<?php echo e($item->rowId); ?>')"></a>
                                    <a class="btn btn-reduce" href="#" wire:click.prevent="decreaseQty('<?php echo e($item->rowId); ?>')"></a>
                                </div>
                            ...
                            <div class="delete">
                                <a href="#" class="btn btn-delete" title="" wire:click.prevent="delCart('<?php echo e($item->rowId); ?>')">
            ...
            <div class="summary">
                <div class="order-summary">
                    ...
                    <p class="summary-info"><span class="title">Discount (<?php echo e(Session::get('coupon')['code']); ?>) <a href="#" wire:click.prevent="removeCoupon"><i class="fa fa-times text-danger"></i></a></span><b class="index"> -$<?php echo e(number_format($discount,2)); ?></b></p>
                    <p class="summary-info"><span class="title">Subtotal Discount</span><b class="index">$<?php echo e(number_format($subtotalAfterDiscount,2)); ?></b></p>
                    ...
                    <p class="summary-info"><span class="title">Shipping</span><b class="index">5% From Subtotal</b></p>
                ...
                <ul class="products-cart">
                    <?php $__currentLoopData = Cart::instance('saveForLater')->content(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li class="pr-cart-item">
                            ...
                            <div class="delete">
                                <a href="#" class="btn btn-delete" title="" wire:click.prevent="deleteFromSaveForLater('<?php echo e($item->rowId); ?>')">
...
<?php /**PATH D:\Xampp\htdocs\E - Commerce\resources\views/livewire/cart-component.blade.php ENDPATH**/ ?>
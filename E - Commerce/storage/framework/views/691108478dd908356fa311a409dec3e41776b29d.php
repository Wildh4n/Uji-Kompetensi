<main id="main" class="main-site left-sidebar">
                                ...
                                <div class="product product-style-3 equal-elem ">
                                    ...
                                    <div class="product-info">
                                        ...
                                        <div class="product-wish">
                                            ...
                                            <a href="#" wire:click.prevent="removeFromWishlish(<?php echo e($product->id); ?>)"><i class="fa fa-heart fill-heart"></i></a>
                                            <?php else: ?>
                        ...
                        <ul class="list-category">
                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="category-item <?php echo e(count($category->subCategories) > 0 ? 'has-child-cate':''); ?>">
                                    ...
                                    <ul class="sub-cate">
                                        <?php $__currentLoopData = $category->subCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li class="category-item">
                                                <a href="<?php echo e(route('product.category',['category_slug'=>$item->slug, 'scategory_slug'=>$item->slug])); ?>" class="cat-link"><i class="fa fa-caret-right"></i>  <?php echo e($item->name); ?></a>
                                            </li>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </ul>
                                <?php endif; ?>
 ...
 <?php $__env->stopPush(); ?>
<?php /**PATH D:\Xampp\htdocs\E - Commerce\resources\views/livewire/shop-component.blade.php ENDPATH**/ ?>
...
} elseif ($_instance->childHasBeenRendered('RGwyhD5')) {
    $componentId = $_instance->getRenderedChildComponentId('RGwyhD5');
    $componentTag = $_instance->getRenderedChildComponentTagName('RGwyhD5');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('RGwyhD5');
} else {
    $response = \Livewire\Livewire::mount('header-search-component');
    $html = $response->html();
    $_instance->logRenderedChild('RGwyhD5', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('D4cRSJg')) {
    $componentId = $_instance->getRenderedChildComponentId('D4cRSJg');
    $componentTag = $_instance->getRenderedChildComponentTagName('D4cRSJg');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('D4cRSJg');
} else {
    $response = \Livewire\Livewire::mount('wishlist-count-component');
    $html = $response->html();
    $_instance->logRenderedChild('D4cRSJg', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                <?php
...
} elseif ($_instance->childHasBeenRendered('LBG2yLz')) {
    $componentId = $_instance->getRenderedChildComponentId('LBG2yLz');
    $componentTag = $_instance->getRenderedChildComponentTagName('LBG2yLz');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('LBG2yLz');
} else {
    $response = \Livewire\Livewire::mount('cart-count-component');
    $html = $response->html();
    $_instance->logRenderedChild('LBG2yLz', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('OAKANVk')) {
    $componentId = $_instance->getRenderedChildComponentId('OAKANVk');
    $componentTag = $_instance->getRenderedChildComponentTagName('OAKANVk');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('OAKANVk');
} else {
    $response = \Livewire\Livewire::mount('footer-component');
    $html = $response->html();
    $_instance->logRenderedChild('OAKANVk', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH F:\ecommers-main\resources\views/layouts/base.blade.php ENDPATH**/ ?>